...
module.exports = { 
    ...
    create_Account: async (Request, Response) => {
        ...
        try {
            ...
            if(create_User.err) return Response.status(400).json({ err : create_User.err });
    ...
    my_Data_Account: async (Request, Response) => {
        ...
        try {
            ...
            if(user_Data.err) return Response.status(404).json({ err: user_Data.err });
    ...
    create_Pedido: async(Request, Response) => {
        ...
        try {
            ...
            if(pedido.err) return Response.status(404).json({ err: pedido.err });
